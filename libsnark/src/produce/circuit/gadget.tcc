...
class produce_gadget : public gadget<FieldT> {
public:
    ...
    std::shared_ptr<digest_variable<FieldT>> role;
    ...
    produce_gadget(
        ...
        // Verification
        {
            ...
            alloc_uint256(zk_unpacked_inputs, role);
    ...
    void generate_r1cs_constraints() { 
        ...
        role->generate_r1cs_constraints();
    ...
    void generate_r1cs_witness(
        ...
        role->bits.fill_with_bits(this->pb, uint256_to_bool_vector(role_data));
    ...
    static r1cs_primary_input<FieldT> witness_map(
        ...
        insert_uint256(verify_inputs, role);
